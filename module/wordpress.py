...
""").split("\n")
    ...
    try:
        ...
        url = input(Fore.RED+" ┌─["+Fore.LIGHTGREEN_EX+"irnofoz"+Fore.BLUE+"~"+Fore.WHITE+"@HOME"+Fore.RED+"/"+Fore.CYAN+"CMN"+Fore.RED+"/"+Fore.LIGHTYELLOW_EX+"WP"+Fore.RED+"/"+Fore.GREEN+"Get-Plugins"+Fore.RED+"""]
 └──╼ 卐 """).lower()
        if url == "" or None:
